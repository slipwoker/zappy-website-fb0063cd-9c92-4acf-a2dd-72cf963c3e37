document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      formMessage.textContent = 'שולח הודעה...';
      formMessage.className = 'form-message';
      formMessage.style.display = 'block';
      
      setTimeout(() => {
        formMessage.textContent = 'תודה רבה! קיבלנו את ההודעה שלך ונחזור אליך בהקדם.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "וידאו מאסטר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'fb0063cd-9c92-4acf-a2dd-72cf963c3e37',
                    name: data.name || '',
                    email: data.email || '',
